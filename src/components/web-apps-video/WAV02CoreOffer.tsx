...
const VIDEO_URL = "/videos/19.mp4";

export function WAV02CoreOffer() {
    ...
    >
      <div className="w-full max-w-7xl mx-auto px-4 md:px-16">
        <div ref={titleRef} className="mb-8 md:mb-16 text-center">
          ...
          >
            Custom <span style={{ color: "#0040C8" }}>Internal Apps</span>
            <br />
        ...
        <div ref={mockupRef}>
          <BrowserWindow videoUrl={VIDEO_URL} url="evolutionarte.app" />
        </div>
      </div>
    </section>
  );
