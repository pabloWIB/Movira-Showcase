    ...
    >
      <DivGrid
        ...
        className={direction === "bottom"
          ? "[mask-image:radial-gradient(ellipse_100%_60%_at_50%_100%,black_20%,transparent_100%)] opacity-60"
          : "[mask-image:radial-gradient(ellipse_100%_60%_at_50%_0%,black_20%,transparent_100%)] opacity-60"
        }
        rows={dims.rows}
        cols={dims.cols}
        cellSize={cellSize}
